...
// Directory Page Script (members list, spotlights, grid/list view)
...
if (membersContainer) {
  ...
  function displaySpotlights(members) {
    ...
    if (!container) return; // exit if spotlight container not on page
    container.innerHTML = '';
  ...
  // Kick off fetching members if container exists
  fetchMembers();
}

// Events Page Script (weather data)
